...
namespace ZC
{
    class HandleCI1Data
    {
        ...
        private void UnPackReturnAccessState()
        {
            ...
            {
                bool IsReturnAccessOpen = struct_.GetBit();
                Info.Add(IsReturnAccessOpen);
            }
            SetReturnAccessState();
        }

        private void SetReturnAccessState()
        {
            AddCIAccess.CITableListTop[20].IsReturn = Info[0] == true ? true : false;
            AddCIAccess.CITableListTop[8].IsReturn = Info[1] == true ? true : false;
            AddCIAccess.CITableListTop[3].IsReturn = Info[2] == true ? true : false;
            AddCIAccess.CITableListTop[23].IsReturn = Info[3] == true ? true : false;
            AddCIAccess.CITableListTop[27].IsReturn = Info[4] == true ? true : false;
            AddCIAccess.CITableListTop[29].IsReturn = Info[5] == true ? true : false;
        }
